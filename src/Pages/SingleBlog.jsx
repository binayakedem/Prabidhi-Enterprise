...
const SingleBlog = () => {
  ...
  return (
   <div>
    <div className=' bg-[#1b1a1a] text-center flex flex-col h-60 w-full justify-center items-center'>
        <h1 className='font-bold text-3xl text-white'>Thanks for visiting
             </h1>
             <h1 className='text-[#FFCD03] font-bold text-3xl'> innovation partner!</h1>
      </div>
      <div className='mx-4 md:mx-12 lg:mx-24 my-10 gap-10'>
            ...
            <h1 className='text-black font-bold text-3xl mb-6'>{job.title}</h1>
            <h2 className='text-gray-800 font-semibold text-lg mb-3'>{job.sub_heading}</h2>
            <p className='text-gray-600'>{job.paragraph}</p>   

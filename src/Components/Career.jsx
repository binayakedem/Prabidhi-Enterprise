...
const Career = () => {
  ...
  return (
    <div >
      <div className=' bg-[#29589f] text-center flex flex-col h-60 w-full justify-center items-center'>
        <h1 className='font-bold text-3xl text-white'>Find Your best job
             </h1>
             <h1 className='text-[#FFCD03] font-bold text-3xl'> Get ready to join!</h1>
      </div>
